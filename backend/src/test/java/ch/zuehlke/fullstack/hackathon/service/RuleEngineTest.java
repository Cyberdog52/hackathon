...
class RuleEngineTest {
    ...
    public static Stream<Arguments> winningHands() {
        return Stream.of(
                ...
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(CLUBS, TWO), new Card(CLUBS, THREE), new Card(CLUBS, FOUR), new Card(CLUBS, FIVE), new Card(CLUBS, SIX), new Card(CLUBS, SEVEN)), -10)      // ♣A ♣2 ♣3 ♣4 ♣5 ♣6 ♣7         | Chinchon -> Score -10
        );
    }
    ...
    public static Stream<Arguments> unfilteredScore() {
        return Stream.of(
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(SPADE, ACE), new Card(DIAMOND, ACE), new Card(HEART, EIGHT), new Card(HEART, NINE), new Card(HEART, TEN), new Card(HEART, FIVE)), 35),       // ♣A ♠A ♦A     |  ♥8 ♥9 ♥10    | ♥5
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(SPADE, ACE), new Card(DIAMOND, ACE), new Card(HEART, EIGHT), new Card(HEART, NINE), new Card(HEART, TEN), new Card(HEART, JACK)), 40),       // ♣A ♠A ♦A     |  ♥8 ♥9 ♥10 ♥J |
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(SPADE, ACE), new Card(DIAMOND, ACE), new Card(HEART, ACE), new Card(HEART, NINE), new Card(HEART, TEN), new Card(HEART, JACK)), 33),         // ♣A ♠A ♦A ♥A  |  ♥9 ♥10 ♥J    |
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(SPADE, ACE), new Card(DIAMOND, ACE), new Card(DIAMOND, TWO), new Card(DIAMOND, THREE), new Card(DIAMOND, FOUR), new Card(HEART, FIVE)), 17), // ♣A ♠A ♦A     | ♦2 ♦3 ♦4      | ♥5
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(SPADE, ACE), new Card(DIAMOND, ACE), new Card(HEART, ACE), new Card(HEART, TWO), new Card(HEART, THREE), new Card(HEART, FIVE)), 14),        // ♣A ♠A ♦A     | ♥A ♥2 ♥3      | ♥5
                Arguments.of(Set.of(new Card(CLUBS, ACE), new Card(CLUBS, TWO), new Card(CLUBS, THREE), new Card(CLUBS, FOUR), new Card(CLUBS, FIVE), new Card(CLUBS, SIX), new Card(CLUBS, SEVEN)), 28)        // ♣A ♣2 ♣3 ♣4 ♣5 ♣6 ♣7         |
        );
    }
    ...
    @ParameterizedTest
    @MethodSource("winningHands")
    void isWinningHand(Set<Card> cards, int score) {
    ...
    @ParameterizedTest
    @MethodSource("losingHands")
    void isLosingHand(Set<Card> cards, int score) {
        var result = RuleEngine.isWinning(cards);
  ...
  /*  @ParameterizedTest
    ...
    void calculateScore(Set<Card> cards, int score) {
        var result = RuleEngine.calculateScore(cards);
