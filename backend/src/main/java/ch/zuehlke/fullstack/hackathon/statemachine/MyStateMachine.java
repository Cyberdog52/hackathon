...
public class MyStateMachine {
    ...
    public Flux<StateMachineEventResult<ch.zuehlke.common.GameState, GameEvent>> attack(
        AttackTurnAction request) {
        var message = MessageBuilder.withPayload(GameEvent.ATTACK)
